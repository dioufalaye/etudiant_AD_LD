  ...
  <body>
   <div class="container-fluid ">
         ...
         <nav class="nav bg-primary   d-flex justify-content-center   "  id="navbar">
           <a class="nav-link active text-white" href="etudiant">Gestion etudiants</a>
           <a class="nav-link text-white" href="chambre">gestion chambres</a>
         </nav>
          <!--- ----------------------- end navbar---------------------------------------->
          <!--- -----------------------content---------------------------------------->
         <div class="w-100 p-3 principale  d-flex " id="load" style="background-color: #eee; height: 71vh;"  >
